...
import { Product, BooksService, Offer } from './books.service';
...
@Component({
  ...
  export class ProductComponent {
    ...
    constructor(private route: ActivatedRoute, private service: BooksService, private loginService: LoginService) {
